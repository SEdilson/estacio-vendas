...
public class AppUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        visualizaButton.setText("Ver");

        comprasButton.setText("Compras");
        visualizaButton.add(comprasButton);

        menuApp.add(visualizaButton);
